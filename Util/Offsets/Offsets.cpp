...
void CUtil_Offsets::Init()
{
	...
	m_dwCLSendMove = U::Pattern.Find(_("engine.dll"), _("55 8B EC B8 ? ? ? ? E8 ? ? ? ? A1 ? ? ? ? 33 C5 89 45 FC 56 E8 ? ? ? ? 8D B0 ? ? ? ? E8 ? ? ? ? 8B 80 ? ? ? ? 8B 0E 8D 54 08 01 89 95 ? ? ? ? E8 ? ? ? ? 8B 80 ? ? ? ? 8B 0D ? ? ? ? 8B 11 89 85 ? ? ? ? 8B 42 20 FF D0 8B F0 89 B5 ? ? ? ? 83 FE FF 0F 84"));
	XASSERT(m_dwCLSendMove == 0x0);

	m_dwBaseEntityInterpolate = U::Pattern.Find(_("client.dll"), _("55 8B EC 83 EC ? 53 57 8D 45"));
	XASSERT(m_dwBaseEntityInterpolate == 0x0);

	m_dwSequenceName = U::Pattern.Find(_("client.dll"), _("55 8B EC 56 57 8B 7D ? 8B F1 83 FF ? 75"));
	XASSERT(m_dwSequenceName == 0x0);
	// oh boy. big stonky sig coming up.
	m_dwGetClientInterpAmount = U::Pattern.Find(_("client.dll"), _("55 8B EC B8 ? ? ? ? 83 EC ? 84 05"));
	XASSERT(m_dwGetClientInterpAmount == 0x0);
